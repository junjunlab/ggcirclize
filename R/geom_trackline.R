...
#' @export
GeomTrackline <- ggproto("GeomTrackline", GeomArcline,
...
#' geom_trackline Function
#'
#' This is a custom geom function used to draw a trackline plot.
#'
...
#' @import ggplot2
#' @export
geom_trackline <- function(mapping = NULL, data = NULL,
