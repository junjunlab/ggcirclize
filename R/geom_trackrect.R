...
#' @export
GeomTrackrect <- ggproto("GeomTrackrect", GeomArcrect,
...
#' geom_trackrect Function
#'
#' This is a custom geom function used to draw a track rectangle plot.
#'
...
#' @import ggplot2
#' @export
geom_trackrect <- function(mapping = NULL, data = NULL,
