...
#' @export
GeomTrackgenomicrect <- ggproto("GeomTrackgenomicrect", GeomArcrect,
...
#' geom_trackgenomicrect Function
#'
...
#' @import ggplot2
#' @export
geom_trackgenomicrect <- function(mapping = NULL, data = NULL,
