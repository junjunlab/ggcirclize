...
#' @usage NULL
#' @import ggplot2
#' @include geom_arcsector.R
#' @export
GeomTracksector <- ggproto("GeomTracksector", GeomArcsector,
                           ...
                           draw_panel = function(self,data, panel_params, coord,
                             ...
                             for (sec in seq_along(gp)) {
                               ...
                               ptack <-
                                 ggproto_parent(GeomArcsector, self)$draw_panel(
...
#' geom_tracksector Function
#'
#' This is a custom geom function used to draw track sector plots.
#'
...
#' @import ggplot2
#' @export
geom_tracksector <- function(mapping = NULL, data = NULL,
