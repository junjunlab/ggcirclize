...
#' @export
GeomTrackarea <- ggproto("GeomTrackarea", GeomArcarea,
                         ...
                         draw_panel = function(self,data, panel_params, coord,
                           ...
                           for (sec in seq_along(gp)) {
                             ...
                             ptack <-
                               ggproto_parent(GeomArcarea, self)$draw_panel(
...
#' geom_trackarea Function
#'
#' This is a custom geom function used to draw a track area plot.
#'
...
#' @param strip.label.space The spacing between track labels and track areas (default = 0.15).
...
#' @param space Specifies the spatial type for track areas (default = "free_x").
#' @param sector.gap The gap between track areas (default = 3).
...
#' @import ggplot2
#' @export
geom_trackarea <- function(mapping = NULL, data = NULL,
