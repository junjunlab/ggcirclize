...
#' @export
GeomTrackgenomicarea <- ggproto("GeomTrackgenomicarea", GeomArcpolygon,
...
#' geom_trackgenomicarea Function
#'
#' This is a custom geom function used to draw track genomic area plots.
#'
...
#' @param polar.every Whether to use polar coordinates for every track (default = FALSE).
...
#' @import ggplot2
#' @export
geom_trackgenomicarea <- function(mapping = NULL, data = NULL,
