...
#' @export
GeomTrackpoint <- ggproto("GeomTrackpoint", GeomArcpoint,
...
#' geom_trackpoint Function
#'
#' This is a custom geom function used to draw a trackpoint plot.
#'
...
#' @param strip.label.space The spacing between track labels and track points (default = 0.15).
...
#' @param space Specifies the spatial type for track points (default = "free_x").
#' @param sector.gap The gap between tracks (default = 3).
...
#' @import ggplot2
#' @export
geom_trackpoint <- function(mapping = NULL, data = NULL,
