...
#' @export
GeomTrackbar <- ggproto("GeomTrackbar", GeomArcbar,
                        ...
                        draw_panel = function(self,data, panel_params, coord,
                          ...
                          for (sec in seq_along(gp)) {
                            ...
                            ptack <-
                              ggproto_parent(GeomArcbar, self)$draw_panel(
...
#' geom_trackbar Function
#'
#' This is a custom geom function used to draw track bar plots.
#'
...
#' @param strip.label.space The spacing between track labels and track bars (default = 0.15).
...
#' @param space Specifies the spatial type for track bars (default = "free_x").
#' @param sector.gap The gap between track bars (default = 3).
...
#' @import ggplot2
#' @export
geom_trackbar <- function(mapping = NULL, data = NULL,
                          stat = "arcbar", position = "identity",
